...
static const usk_command_descriptor USK_COMMANDS[] = {
    ...
    USK_DESCRIPTOR("uninstall.plan", "usk.command_request.v1", "usk.operation_plan.v1", "[\"owned_target_read\",\"state_read\"]", "always_preview", "planned", 1, 0, usk_handle_static, USK_STATUS_ERROR, USK_PLANNED_COMMAND_PAYLOAD, "planned command is unavailable"),
