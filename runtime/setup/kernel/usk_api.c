...
static const char USK_POLICY_PAYLOAD[] =
    "{\"schema\":\"usk.command_response.v1\",\"status\":\"ok\",\"payload\":{\"schema\":\"usk.policy.v1\",\"policy_id\":\"usk.policy.local_only.v1\",\"mutation_scope\":\"staged_root_only\",\"network_allowed\":false,\"registry_allowed\":false,\"elevation_allowed\":false,\"package_manager_allowed\":false,\"product_specific_installer_allowed\":false,\"installer_execution_allowed\":false,\"credential_access_allowed\":false,\"rules\":[{\"rule_id\":\"no_network\",\"effect\":\"refuse\",\"message\":\"network access is not part of the minimal setup contract\"},{\"rule_id\":\"no_registry\",\"effect\":\"refuse\",\"message\":\"registry mutation is not part of the minimal setup contract\"},{\"rule_id\":\"no_elevation\",\"effect\":\"refuse\",\"message\":\"elevation is not part of M1\"},{\"rule_id\":\"no_package_manager\",\"effect\":\"refuse\",\"message\":\"package-manager mutation is not part of the minimal setup contract\"},{\"rule_id\":\"no_installer_execution\",\"effect\":\"refuse\",\"message\":\"vendor installer execution is not part of M1\"},{\"rule_id\":\"no_credentials\",\"effect\":\"refuse\",\"message\":\"credential access is not part of M1\"}]},\"error\":null}";
static const char USK_VERIFY_REPORT_PAYLOAD[] =
    "{\"schema\":\"usk.command_response.v1\",\"status\":\"unavailable\",\"payload\":null,\"error\":{\"code\":\"verification_not_implemented\",\"message\":\"installed-state verification is not implemented\"}}";
...
static const usk_command_descriptor USK_COMMANDS[] = {
    ...
    USK_DESCRIPTOR("repair.plan", "usk.repair_plan_request.v1", "usk.repair_plan.v1", "[\"source_read\",\"owned_target_read\",\"state_read\"]", "always_preview", "available", 1, 0, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("repair.apply", "usk.repair_apply_request.v1", "usk.repair_report.v1", "[\"owned_target_write\",\"state_write\",\"audit_write\"]", "reviewed_plan_required", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("update.plan", "usk.update_plan_request.v1", "usk.update_plan.v1", "[\"source_read\",\"owned_target_read\",\"state_read\"]", "always_preview", "available", 1, 0, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("update.apply", "usk.update_apply_request.v1", "usk.update_report.v1", "[\"source_read\",\"owned_target_read\",\"state_read\",\"owned_target_write\",\"state_write\",\"audit_write\"]", "reviewed_plan_required", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("move.plan", "usk.move_plan_request.v1", "usk.operation_plan.v1", "[\"owned_target_read\",\"state_read\",\"target_read\"]", "always_preview", "available", 1, 0, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("move.apply", "usk.move_apply_request.v1", "usk.move_report.v1", "[\"owned_target_write\",\"state_write\",\"audit_write\"]", "reviewed_plan_required", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("uninstall.plan", "usk.uninstall_plan_request.v1", "usk.operation_plan.v1", "[\"owned_target_read\",\"state_read\"]", "always_preview", "available", 1, 0, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("uninstall.apply", "usk.uninstall_apply_request.v1", "usk.uninstall_report.v1", "[\"owned_target_write\",\"state_write\",\"audit_write\"]", "reviewed_plan_required", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("recovery.inspect", "usk.recovery_inspect_request.v1", "usk.recovery_report.v1", "[\"journal_read\"]", "read_only", "available", 1, 0, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("recovery.plan", "usk.recovery_plan_request.v1", "usk.recovery_plan.v1", "[\"journal_read\",\"owned_target_read\"]", "always_preview", "available", 1, 0, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("live_evidence.capture", "usk.live_target_evidence_capture_request.v1", "usk.live_target_evidence_packet.v1", "[\"state_read\",\"audit_read\",\"journal_read\",\"evidence_write\"]", "explicit_capture", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("live_evidence.verdict.record", "usk.operator_verdict_record_request.v1", "usk.live_target_evidence_packet.v1", "[\"evidence_read\",\"evidence_write\"]", "explicit_human_record", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
    USK_DESCRIPTOR("recovery.apply", "usk.recovery_apply_request.v1", "usk.recovery_report.v1", "[\"owned_target_write\",\"state_write\",\"audit_write\"]", "reviewed_plan_required", "available", 0, 1, usk_handle_public_lifecycle, USK_STATUS_OK, 0, 0),
