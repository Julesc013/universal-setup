...
usk_spec: {"profile":"usk-engineering/0.1.0-draft.1","id":"USK-S-TASK-015","revision":"3","status":"proposed","authority":"engineering-intent-only-after-adoption","owner":"universal-setup","layer":"plan","depends_on":["USK-S-API","USK-S-TXN"]}
