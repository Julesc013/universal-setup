...
The exact state-repository implementation file is writable for ownership-record memory work; state schemas, release evidence and other state files remain outside this scope.
